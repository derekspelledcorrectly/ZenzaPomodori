...
struct NotificationServiceTests {
    private func makeStore(soundEnabled: Bool) -> SettingsStore {
    ...
    @Test func notificationContentIncludesSoundWhenEnabled() {
    ...
    @Test func notificationContentExcludesSoundWhenDisabled() {
